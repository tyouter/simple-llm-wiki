...
updated_at: "2026-04-23T00:42:26.616691"
related:
  - "Vibe Coding"
  - "Plan"
  - "Humanize"
...
[[Humanize插件]]是Spec Coding的一种具体实现模式，通过迭代反馈循环确保代码质量。Spec Coding也自然支持[[Agent]]——清晰的Spec和Plan使得任务分解和分配成为可能，不同Agent可以基于统一的规格说明并行工作。
