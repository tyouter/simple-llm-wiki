...
updated_at: "2026-04-21T18:02:02.810310"
related:
...
这个过程可以被视为对[[Agent Memory Systems]]（在这里，Git仓库是团队的集体记忆）的查询和总结。它与[[AI-Enhanced Note-Taking]]有相似之处，都是将原始信息转化为可操作的洞察。在[[基于角色的AI开发]]范式中，`/retro`技能扮演了“数据分析师”或“敏捷教练”的角色，为回顾会议提供数据驱动的讨论基础，从而帮助团队持续改进。
