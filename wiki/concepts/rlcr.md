...
updated_at: "2026-04-21T14:13:50.854661"
related:
  - "Plan"
  - "Humanize"
  - "蜂群"
...
## 定义
一种[[AI驱动]]的代码重构与修改方法，名称可能为"Refactor, Loop, Check, Repeat"或类似含义的缩写。在[[Claude Code高效配置与开发实践指南]]中，[[yahah]]将其描述为针对大规模代码修改任务的方法论。
...
## 成功案例
[[yahah]]分享了一个标志性成功案例：使用RLCR结合"[[蜂群]]"在**四小时内**完成了[[gem5]]仓库（一个广泛使用的计算机系统架构模拟器）构建系统从SCons到CMake的彻底替换。这展示了RLCR处理复杂、大规模工程任务的能力。
...
**backlinks_note**: 本概念在[[Claude Code高效配置与开发实践指南]]中作为高级开发方法论被介绍，由[[yahah]]详细描述，与[[Humanize]]互补，成功应用于[[gem5]]项目。
