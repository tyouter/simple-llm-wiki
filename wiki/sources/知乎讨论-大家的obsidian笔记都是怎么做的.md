---
title: "知乎讨论：大家的obsidian笔记都是怎么做的"
type: "source"
sources:
...
## 来源概述
知乎上的一个讨论帖，用户分享各自的[[Obsidian]]工作流，重点关注AI集成、版本控制和插件使用。讨论展现了知识管理的多元哲学取向，从AI增强自动化到严谨的手动组织都有涉及。
...
## 哲学张力
- **自动化vs手动控制**：讨论展现了AI辅助自动化（通过obsidian-skills）与强调深思熟虑的手动组织的纯粹主义之间的张力。
...
## 来源归属
- **平台**：知乎讨论帖
- **参与者**：各类Obsidian用户，包括开发者与重度用户
- **关键人物**：[[Steph Ango (kepano)]]作为obsidian-skills工具包创建者

## 标签
obsidian, 笔记方法, 知识管理, ai集成, git, markdown, 知乎, 工作流, claude-code, 自动化
